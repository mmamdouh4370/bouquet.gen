...
class BaseSavedBouquet(_PrismaModel):
    __prisma_model__: ClassVar[Literal['SavedBouquet']] = 'SavedBouquet'  # pyright: ignore[reportIncompatibleVariableOverride]

    @classmethod
    def prisma(cls: Type[_PrismaModelT], client: Optional['Prisma'] = None) -> 'actions.SavedBouquetActions[_PrismaModelT]':
        from .client import get_client

        return actions.SavedBouquetActions[_PrismaModelT](client or get_client(), cls)
